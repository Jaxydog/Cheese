...
/** Aliased block item wrapper class to provide for additional mod functionality */
public class CAliasedBlockItem extends AliasedBlockItem implements Registerable {
	...
	/** Creates a new item */
	public CAliasedBlockItem(String name, Block block, Settings settings, Config config) {
	...
	public CAliasedBlockItem(String name, Block block, Settings settings) {
